...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const { user } = useAuth()
  const { collapsed, pinned, toggle } = useSidebar()
  ...
  const getNavigationItems = (): NavigationItem[] => {
    ...
    const roleBasedItems: Record<UserRole, NavigationItem[]> = {
      admin: [
        ...baseItems,
        {
        ...
        <div className={clsx(
          ...
          {!collapsed && (
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-gray-900">AKBID</span>
            </div>
          )}
          ...
          {!collapsed && user?.role && (
            <div className="mt-8 pt-4 border-t border-gray-200">
              ...
              <div className="space-y-1">
                ...
                {(user.role === 'dosen' || user.role === 'laboran') && (
                  <button className="w-full flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg">
                    <svg className="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
